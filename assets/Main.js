...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:26px;">选择你要的内容：</span><br /><span style="font-size:15px;"><br />1. 新员工入职流程；<br />2.用款报销；<br />3. 请假流程；<br />4. 用章申请；<br />5. 离职流程。</span>';
